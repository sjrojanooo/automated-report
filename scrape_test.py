...
def scrape_main(): 
    ...
    condition_excel_files(dataFrame, area_list)
...
def conditional_frame(dataFrame: object, boxDataFrame, area_list: list):
    ...
    try: 
        ...
        print("ERROR HAPPENED AT CONDITIONAL FRAME!!!")
...
def return_box_label_columns(area: str):
    ...
    try: 
        ...
        print("ERROR HAPPENED AT return_box_labels_columns"); 
...
def join_data_by_area(dataFrame: object, boxDataFrame: object, area: str): 
    ...
    try: 
        ...
        print("ERROR HAPPENNED AT join_data_by_area METHOD")
...
def create_grand_summary(dataFrame: object):
    ...
    try: 
        ...
        print("ERROR HAPPENNED AT create_grand_summary method")
...
def condition_excel_files(detailed_frame: object, area_list):
    ...
    try: 
        ...
        print("ERROR HAPPENNED AT conditional_excel_files METHOD!!!")